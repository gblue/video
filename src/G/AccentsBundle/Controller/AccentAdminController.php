...
namespace G\AccentsBundle\Controller;
...
class AccentAdminController extends CRUDController
{
    public function historyAction($id = null)
    {
        ...
        return $this->render('GAccentsBundle:Admin:history.html.twig', array(
            'object' => $object,
            'revisions' => $logs,
            'action' => 'history',
            'locale' => $locale
    ...
    public function historyViewRevisionAction($id = null, $revision = null)
    {
        ...
        return $this->render('GAccentsBundle:Admin:show.html.twig', array(
            'object' => $object,
    ...
    public function historyRevertToRevisionAction($id = null, $revision = null)
    {
		...
		return new RedirectResponse($this->container->get('router')->generate('admin_stenik_accent_accent_edit', array('id' => $object->getId())));
    }
}
